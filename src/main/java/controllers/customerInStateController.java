 ...
 */
@WebServlet(name = "customerInStateController", urlPatterns = {"/customerInStateController"})
public class customerInStateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("views/customerInStateView.jsp").forward(request, response);
